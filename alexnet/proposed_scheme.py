...
#                   count += 1
       ...
       print("wfc1:{}, bfc1:{}, wfc2:{}, bfc2:{}, wfc3:{}, bfc3:{}".format(memory_size[10]/float(1000000), memory_size[11]/float(1000000), memory_size[12]/float(1000000), memory_size[13]/float(1000000), memory_size[14]/float(1000000), memory_size[15]/float(1000000)))
...
#		os.makedirs(CKPT_PATH)
	SUMMARY = '/home/h-iwasaki/alexnet/codes/summary/kmeans/fc1/qp_' + str(QUALITY_PARAMETER) + '/manual/validation/' + str(column_num)
	if not os.path.exists(SUMMARY):
		os.makedirs(SUMMARY)
	CKPT_PATH_un0 = '/home/h-iwasaki/alexnet/codes/ckpt/retrain_with_relu/fc1/qp_' + str(QUALITY_PARAMETER)
	...
	SAVE_PATH_pr0 = '/home/h-iwasaki/alexnet/codes/ckpt/kmeans/fc1/qp_' + str(QUALITY_PARAMETER) + '/manual/' + str(column_num)
	if not os.path.exists(SAVE_PATH_pr0):
		os.makedirs(SAVE_PATH_pr0)
	SAVE_PATH_un1 = '/home/h-iwasaki/alexnet/codes/ckpt-alexnet-un1'
